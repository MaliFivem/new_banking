...
--[[if bankMenu then
	...
	if nearBank() or nearATM() then
		...
		exports['pogressBar']:drawBar(2500, 'Kart veriliyor!')  
			playAnim('mp_common', 'givetake1_a', 2500)
			SetNuiFocus(true, false)
			inMenu = false
			Citizen.Wait(2500)
			exports['mythic_notify']:SendAlert('inform', 'Giriş yapıldı!', 2500, { ['background-color'] = '#31a4eb', ['color'] = '#ffffff' })
			inMenu = true
...
RegisterCommand('atm', function()
    if bankMenu then
		if nearBank() or nearATM() then
			exports['progressBars']:startUI(2500, 'Kart veriliyor!')
			playAnim('mp_common', 'givetake1_a', 2500)
			SetNuiFocus(true, false)
			inMenu = false
			Citizen.Wait(2500)
...
RegisterNUICallback('NUIFocusOff', function()
	inMenu = false
	SetNuiFocus(false, false)
	exports['progressBars']:startUI(2500, 'Kart alınıyor!')
			playAnim('mp_common', 'givetake1_a', 2500)
			SetNuiFocus(true, false)
			inMenu = false
			Citizen.Wait(2500)
			exports['mythic_notify']:SendAlert('inform', 'Çıkış yapıldı!', 2500, { ['background-color'] = '#31a4eb', ['color'] = '#ffffff' })
			Citizen.Wait(100)
			SetNuiFocus(false, false)
